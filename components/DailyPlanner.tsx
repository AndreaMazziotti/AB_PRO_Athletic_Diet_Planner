...
const DailyPlanner: React.FC<DailyPlannerProps> = ({ state, selectedDate, onDateChange, onSaveMeal, onManualDayTypeChange, onGenerateWeekPlan }) => {
  ...
  return (
    ...
    >
      ...
      <div className="box-control grid grid-cols-[1fr_auto_1fr] items-center justify-items-center gap-2 md:gap-4 bg-[var(--background-secondary)] p-3 md:p-6 rounded-xl md:rounded-[2rem]">
        <button
      ...
      {!isFacileMode && (
      <div className="box-control bg-[var(--background-secondary)] p-3 md:p-8 rounded-xl md:rounded-[2rem] overflow-hidden">
      ...
      <div className="box-control box-summary p-3 md:p-8 rounded-xl md:rounded-[2.5rem] transition-all overflow-hidden">
      ...
      <div className="mt-6 md:mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10">
        {mealsToShow.map(pasto => {
          ...
          return (
            <div key={pasto} className={`box-meal rounded-xl md:rounded-[2.5rem] flex flex-col transition-all relative overflow-hidden ${status === 'skipped' ? 'box-meal-skipped grayscale opacity-70' :
              status === 'cheat' ? 'box-meal-cheat' : ''
              }`}>
